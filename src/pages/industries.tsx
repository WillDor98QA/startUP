...
export default function IndustriesPage() {
  return (
    <>
      <Seo title="Industries" description="Digital transformation tailored to your sector — retail, healthcare, insurance, education, manufacturing, construction, hospitality, NGOs, and professional services." />
