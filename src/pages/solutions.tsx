...
export default function SolutionsPage() {
  return (
    <>
      <Seo title="Solutions" description="Outcome-led digital solutions for growing businesses: custom software, process automation, AI, business dashboards, systems integration, and mobile apps." />
      <PageHero
        eyebrow="Solutions"
