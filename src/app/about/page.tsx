...
export const metadata: Metadata = {
  title: "About",
  description:
    "Kova exists to make digital transformation accessible to every growing business. Meet the team closing the gap between SMEs and enterprise-grade software.",
};
